            ...
            for (let x = 0; x < gridSize; x++) {
                for (let y = 0; y < gridSize; y++) {
                    ...
                    const province: Province = {
                        ...
                        oilBonus: Math.floor(random() * 10),
                        gasBonus: Math.floor(random() * 8),
                        uraniumBonus: Math.floor(random() * 3),
                        lithiumBonus: Math.floor(random() * 5),
                        rareEarthBonus: Math.floor(random() * 4),
                        copperBonus: Math.floor(random() * 8),
                        goldBonus: Math.floor(random() * 6),
                        steelBonus: Math.floor(random() * 10) + 5,
                        siliconBonus: Math.floor(random() * 7),
